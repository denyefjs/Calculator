...
- **AC** – setzt den Rechner komplett zurück
- Visuell strukturierte Oberfläche mit farbcodierten Tasten
- Dynamisches Display mit korrekter Formatierung (z. B. Entfernen unnötiger „.0“)
...
3. Der Taschenrechner startet in einem neuen Fenster.
...
- Eigenständige Gestaltung eines UI-Layout-Systems
- Strukturierte Trennung von Logik und Darstellung
- Verwendung von Arrays zur Button-Generierung
...
**GitHub-Profil:** https://github.com/denyefjs
**E-Mail:** denis.efremov567@gmail.com
